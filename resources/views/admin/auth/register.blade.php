    ...
    <div class="flex items-center justify-center h-screen bg-gray-100">
        <div class="w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-hidden flex">
            ...
            <div class="w-1/2 p-10">
                <h2 class="text-2xl font-semibold text-green-700 mb-4">Admin Register</h2>
                <p class="text-gray-600 mb-8">Already have an account? <a href="{{ route('admin.login') }}" class="text-green-700 font-medium">Log in</a></p>
