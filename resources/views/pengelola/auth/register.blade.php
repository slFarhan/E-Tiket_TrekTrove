    ...
    <script>
        document.getElementById('user_type').addEventListener('change', function() {
            if (this.value === 'pengelola') {
                window.location.href = "{{ route('pengelola.register') }}"; // Ganti dengan route login untuk Admin Pengelola
            } else if (this.value === 'user') {
                window.location.href = "{{ route('register') }}"; // Ganti dengan route login untuk Pengelola
            }
        });
    </script>
</body>
