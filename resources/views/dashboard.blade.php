...
<body>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <!-- Bagian Gambar - Sekarang berada di sebelah kiri -->
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img class="h-auto max-w-md rounded-lg" src="images/IMG_2032.JPG" alt="mockup">


            </div>

            <!-- Bagian Teks - Sekarang berada di sebelah kanan -->
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <a href="{{ route('destinasi', ['kategori' => 'hiburan']) }}"
                    class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    Hiburan
                </a>
                <a href="{{ route('destinasi', ['kategori' => 'kuliner']) }}"
                    class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    Kuliner
                </a>
            </div>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-4">Selamat datang di Trektrove. Kami adalah sebuah platform informasi serta pemesanan tiket
                    untuk setiap jenis petualangan, hiburan dan kuliner yang ada di Bandung.</p>
                <p>─ Ciptakan kesan menarik dan tak terlupakan di Bandung bersama kami Trektrove.</p>
            </div>
            <div class="grid grid-cols-2 gap-4 mt-8">
                <img class="w-full rounded-lg" src="images/IMG_1400.JPG" alt="office content 1">
                <img class="mt-4 w-full lg:mt-10 rounded-lg" src="images/bandung.jpg" alt="office content 2">
            </div>
            <ol
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Destinasi paling
                    populer di 2024</h2>
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="images/logo2.png" class="h-12 me-3" alt="Trektrove" />
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Trektrove</span>
                    </a>
                </div>
